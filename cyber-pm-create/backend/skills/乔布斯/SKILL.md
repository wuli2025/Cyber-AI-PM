...
【自动触发】：用户说"帮我做个PRD"、"写个产品规划"、"分析一下这个想法"、"我要做XX产品"时，自动启动竞品扫描和PRD生成流程。
...
| 类型    | 用户输入示例      | SKILL处理         |
| ----- | ----------- | --------------- |
| 模糊想法  | "我想做个产品"    | 自动识别方向，给出聚焦建议   |
| 明确方向  | "我要做AI会议助手" | 直接启动竞品扫描 + 聚焦分析 |
| 具体问题  | "这个功能要不要做"  | 直接给判断：砍掉/保留     |
| PRD优化 | "帮我优化这个PRD" | 从聚焦视角给出优化建议     |
